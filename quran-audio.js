...
(function () {
    ...
    function setMediaSession() {
        ...
        try {
            ...
            navigator.mediaSession.metadata = new MediaMetadata({title: `سورة ${context.chapter.name} — الآية ${state.ayah}`, artist: reciter?.name || 'القرآن الكريم', album: 'زاد الذاكرين'});
