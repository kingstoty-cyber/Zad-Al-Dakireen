const CACHE_NAME = 'zad-al-dakireen-v1-0-0';
const AUDIO_CACHE = 'zad-quran-audio-v45';
const SURAH_AUDIO_CACHE = 'zad-quran-surah-audio-v461';
const APP_ASSETS = [
  './', './index.html', './offline.html', './styles.css', './config.js', './data.js', './verified-adhkar.js', './verified-adhkar.json', './app.js', './quran.js', './prayer.js', './enhancements.js', './quran-features.js', './quran-audio.js', './surah-audio.js', './quran-library.js', './audio-downloads.js', './quran-v48.js', './app-shell.js',
...
self.addEventListener('message', event => {
  ...
  if (event.data && event.data.type === 'GET_VERSION') event.source?.postMessage({type:'APP_VERSION',version:'1.0.0'});
});
